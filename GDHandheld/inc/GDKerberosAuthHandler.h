 ...
 * 
 * The Good Dynamics Runtime stores, in a secure cache, Kerberos tickets
 ...
 * Key Distribution Center (KDC) and in the Good Dynamics management console.
 */
...
public:
     ...
     * ticket that can be delegated. Even if it is requested, such a ticket
     * might not be issued, depending on the configuration of the Kerberos KDC.
     *
     ...
     * for initial Kerberos authentication (PKINIT). The ticket will be stored
     * in the Good Dynamics secure cache, if created.
     *
     ...
     * (KCD) to a specified authentication host, with implicit credentials. The
     * ticket will be stored in the Good Dynamics secure cache, if created.
     *
     * Specify the authentication service address by its fully qualified domain
     * name (FQDN) and port number.
     *
     * Specify in the <tt>allowDelegation</tt> parameter whether to request a
     * ticket that can itself be delegated. Even if it is requested, such a
     * ticket might not be issued, depending on the configuration of the
     * Kerberos KDC.
     * 
